...
public class TestaApp {
	...
	public static void main(String[] args) {
		...
		String saidaEsperada = "Livro: Sistema de Banco de Dados (2012) - 754 "
				+ "páginas - Autores: Abraham Silberschatz, Henry F. Korth, S. Sudarshan";
		...
		t1.add(l1.getPaginas() == 468 && l1.getTitulo().equals("O Senhor dos anéis - A Sociedade do Anel")); // testa
																												// getters
																												// de
																												// paginas
																												// e
		...
		saidaEsperada = "Revista: Superinteressante (3/2021) - editora Abril - edição n°:425";
		...
		saidaEsperada = "exemplar: R0| Data impressão: 30/03/2021\n" + saidaEsperada;
		...
		t4.add(ccb.getExemplares(l1Copy) == 4); // quantas impressoes (cópias) no estoque do Livro "O Senhor dos Anéis -
												// A Sociedade do Anel"
